# Disney SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DisneySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DisneySDK(...) and DisneySDK.test(...) become
#      DisneySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "disney_sdk"
_SDK_CLASS = "DisneySDK"
