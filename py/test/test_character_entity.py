    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set DISNEY_TEST_CHARACTER_ENTID JSON to run live")
        client = setup["client"]
...
def _character_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("DISNEY_TEST_CHARACTER_ENTID"))
    ...
    if env.get("DISNEY_TEST_LIVE") == "TRUE":
        ...
        client = DisneySDK(helpers.to_map(merged_opts))

    _live = env.get("DISNEY_TEST_LIVE") == "TRUE"
    return {
        "client": client,
        "data": entity_data,
        "idmap": idmap_resolved,
        "env": env,
        "explain": env.get("DISNEY_TEST_EXPLAIN") == "TRUE",
        "live": _live,
