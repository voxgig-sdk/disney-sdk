# Disney SDK primary utility test
...
from disney_sdk.utility.voxgig_struct import voxgig_struct as vs
from disney_sdk import DisneySDK
from disney_sdk.core.spec import DisneySpec
from disney_sdk.core.result import DisneyResult
from disney_sdk.core.response import DisneyResponse
from disney_sdk.core.operation import DisneyOperation
from disney_sdk.core.error import DisneyError
from disney_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DisneySDK.test(None, None)
        ...
        class TestInitFeature(DisneyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DisneyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DisneySpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DisneySDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DisneySDK.test(None, setup_opts)
