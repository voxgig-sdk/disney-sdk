...
from disney_sdk.core.control import DisneyControl
...
from disney_sdk.core.helpers import get_ctx_prop, to_map
...
class DisneyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, DisneyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DisneyError(code, msg, self)
