...
from disney_sdk.utility import register

# Load features
from disney_sdk.feature.base_feature import DisneyBaseFeature
from disney_sdk.features import _has_feature, _make_feature
...
class DisneySDK:
    ...
    def get_utility(self):
        return DisneyUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DisneySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from disney_sdk.entity.character_entity import CharacterEntity
        return CharacterEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "DisneySDK":
        if sdkopts is None:
            sdkopts = {}
