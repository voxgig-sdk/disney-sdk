...
The TypeScript SDK for the Disney API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/disney-sdk/releases](https://github.com/voxgig-sdk/disney-sdk/releases)
...
```ts
import { DisneySDK } from '@voxgig-sdk/disney'
...
| `tester(testopts?, sdkopts?)` | `DisneySDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `DisneySDK.test(testopts?, sdkopts?)` | `DisneySDK` | Create a test-mode client. |
...
| `client` | `client(): DisneySDK` | Return the parent SDK client. |
