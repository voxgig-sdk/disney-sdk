# Disney TypeScript SDK Reference

Complete API reference for the Disney TypeScript SDK.
...
#### `DisneySDK.test(testopts?, sdkopts?)`
...
**Returns:** `DisneySDK` instance in test mode.
...
Return the parent `DisneySDK` instance.
