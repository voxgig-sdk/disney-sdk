...
DisneySDK._make_feature = _make_feature


function DisneySDK.new(options)
  local self = setmetatable({}, DisneySDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DisneySDK:options_map()
...
function DisneySDK:get_utility()
  return Utility.copy(self._utility)
end


function DisneySDK:get_root_ctx()
  return self._rootctx
end


function DisneySDK:prepare(fetchargs)
...
function DisneySDK:direct(fetchargs)
...
-- by passing it.
function DisneySDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DisneySDK:graphql(query, variables, ctrl)
...
function DisneySDK:Character(data)
...
function DisneySDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = DisneySDK.new(sdkopts)
  sdk.mode = "test"
