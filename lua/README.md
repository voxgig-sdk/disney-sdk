...
The Lua SDK for the Disney API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/disney-sdk/releases)),
...
```
lua/
├── disney_sdk.lua    -- Main SDK module
...
The main module (`disney_sdk`) exports the SDK constructor
