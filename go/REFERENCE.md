# Disney Golang SDK Reference

Complete API reference for the Disney Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *DisneySDK`
...
#### `Character(data map[string]any) DisneyEntity`
