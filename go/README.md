...
The Golang SDK for the Disney API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/disney-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/disney-sdk=../path/to/github.com/voxgig-sdk/disney-sdk
```
...
```
github.com/voxgig-sdk/disney-sdk/
...
The root package (`github.com/voxgig-sdk/disney-sdk`) re-exports everything needed
