...
func (sdk *DisneySDK) OptionsMap() map[string]any {
...
func (sdk *DisneySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DisneySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DisneySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DisneySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DisneySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DisneySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DisneySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DisneySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DisneySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DisneySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
