...
// Disney SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DisneyMakeRequest
{
    public static function call(DisneyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DisneyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DisneyResponse($fetched);
        } else {
