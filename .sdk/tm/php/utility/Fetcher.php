...
class DisneyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DisneySDK/1.0)';
    ...
    public static function call(DisneyContext $ctx, string $fullurl, array $fetchdef): array
    {
