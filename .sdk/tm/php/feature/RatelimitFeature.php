...
class DisneyRatelimitFeature extends DisneyBaseFeature
{
    ...
    private function _acquire(DisneyContext $ctx): void
    {
    ...
    private function _track(DisneyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
