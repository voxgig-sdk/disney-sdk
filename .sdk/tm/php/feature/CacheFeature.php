...
class DisneyCacheFeature extends DisneyBaseFeature
{
    ...
    private function _through(DisneyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
