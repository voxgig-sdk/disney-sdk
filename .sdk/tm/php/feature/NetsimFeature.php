...
class DisneyNetsimFeature extends DisneyBaseFeature
{
    ...
    private function _simulate(DisneyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DisneyContext $ctx, array $applied): void
    {
        $client = $this->client;
