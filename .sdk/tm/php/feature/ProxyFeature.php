...
class DisneyProxyFeature extends DisneyBaseFeature
{
    ...
    public function init(DisneyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DisneyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
