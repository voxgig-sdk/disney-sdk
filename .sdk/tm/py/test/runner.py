...
class DisneyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DisneyTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DisneyTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DisneyTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
