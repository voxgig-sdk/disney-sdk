...
class DisneyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DisneyTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DisneyTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DisneyTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
