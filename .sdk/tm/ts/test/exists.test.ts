...
describe('exists', async () => {
  ...
  //
  // DisneySDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof DisneySDK, true,
      'DisneySDK.test() must return a client synchronously')
  })
