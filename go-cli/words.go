...
func registerSDKWords(r *eng.Registry, client *sdk.DisneySDK) {
...
func runOp(client *sdk.DisneySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
