...
// Disney SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DisneySDK::test)
...
{
    private const SDK_CLASS = 'DisneySDK';
    ...
    private const SDK_BASE = 'disney_sdk';
