...
class DisneyTestRunner
{
    ...
    {
        $live = self::getenv('DISNEY_TEST_LIVE');
        $override = self::getenv('DISNEY_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DISNEY_TEST_EXPLAIN');
...
class_alias('DisneyTestRunner', 'Runner');
class_alias('DisneyHelpers', 'Helpers');
