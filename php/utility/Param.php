...
// Disney SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class DisneyParam
{
    public static function call(DisneyContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = DisneyHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
