...
class DisneyStreamingFeature extends DisneyBaseFeature
{
    ...
    private function _iterate(DisneyResult $result): \Generator
    {
    ...
    private function _streamable(DisneyContext $ctx): bool
    {
