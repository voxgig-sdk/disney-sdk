...
// Disney SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DisneyTestFeature extends DisneyBaseFeature
{
    ...
    public function init(DisneyContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DisneyContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DisneyContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DisneyContext $ctx, $op, $args): array
    {
