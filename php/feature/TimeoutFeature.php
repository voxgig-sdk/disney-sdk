...
class DisneyTimeoutFeature extends DisneyBaseFeature
{
    ...
    private function _with_timeout(DisneyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DisneyContext $_ctx, float $ms): void
    {
        $client = $this->client;
