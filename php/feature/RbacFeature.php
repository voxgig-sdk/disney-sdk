...
class DisneyRbacFeature extends DisneyBaseFeature
{
    ...
    private function _required(DisneyContext $ctx): ?string
    {
    ...
    private function _reject(DisneyContext $ctx, string $required): void
    {
    ...
    private function _track(DisneyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
