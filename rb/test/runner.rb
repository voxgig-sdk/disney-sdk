...
module DisneyTestRunner
  ...
  def self.env_override(m)
    live = getenv("DISNEY_TEST_LIVE")
    override = getenv("DISNEY_TEST_OVERRIDE")
    ...
    explain = getenv("DISNEY_TEST_EXPLAIN")
    m["DISNEY_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = DisneyTestRunner
Helpers = DisneyHelpers
Vs = VoxgigStruct
