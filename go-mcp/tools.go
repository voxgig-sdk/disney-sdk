...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DisneySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "disney_list",
		Description: "List records from Disney. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "disney_load",
		Description: "Load a single record from Disney. " +
...
func runOp(client *sdk.DisneySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DisneySDK, name string) (sdk.DisneyEntity, error) {
